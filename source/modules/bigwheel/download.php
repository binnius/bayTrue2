...
require_once './source/modules/public/Classes/PHPExcel.php';
	...
	$list = pdo_fetchall("SELECT a.*,b.tel FROM ".tablename('award')." as a  left join ".tablename('bigwheel_fans')." as b on a.rid=b.rid and  a.from_user=b.from_user  WHERE a.rid = :rid and a.weid=:weid   ORDER BY a.id DESC " , array(':rid' => $rid,':weid'=>$_W['weid']));				
