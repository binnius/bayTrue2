    ...
    <div id="navigation">
        <div class="container-fluid">
            ...
            <ul class='main-nav'>
				...
				<li><a href="http://mp.weixin.qq.com/s?__biz=MzA5NjE1MjAyMA==&mid=200597834&idx=1&sn=b10d8252f54924d0fb07a8b36b74af85#rd" target="_blank">功能介绍</a> </li>				
				<li>
                    ...
                    <ul class="dropdown-menu">
						...
						<li><a href="http://mp.weixin.qq.com/s?__biz=MzA5NjE1MjAyMA==&mid=200597834&idx=1&sn=b10d8252f54924d0fb07a8b36b74af85#rd" target="_blank">使用指南</a></li>
						<li><a href="http://mp.weixin.qq.com/s?__biz=MzA5NjE1MjAyMA==&mid=200597834&idx=1&sn=b10d8252f54924d0fb07a8b36b74af85#rd" target="_blank">产品问答</a></li>
                    </ul>
                </li>
            ...
            <div class="user">
                <ul class="icon-nav">
                    <li>
                        <a href="http://www.wxbox.cn" target="_blank" title="打开首页"><i class="icon-home"></i></a></li>
                    <!--                 <li>
        ...
        <div id="left" style="top:2px;">
			...
			<div id="footer_code">
				...
				<div class="contact-service">
					<a href="http://wpa.qq.com/msgrd?v=3&amp;uin=790988023&amp;site=qq&amp;menu=yes" target="_blank" class="" title="在线客服">
						<i class="index-icon-comments-alt"></i>在线客服
					</a>
				</div>
				<div class="contact-phone"><i class="index-icon-phone"></i>18662095583</div>
